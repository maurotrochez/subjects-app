...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener, GoogleApiClient.ConnectionCallbacks,
    ...
    private void updateUI(boolean isSignedIn) {
        if (isSignedIn) {
            ...
            String SERVER_CLIENT_ID = "1078261582554-63am6g9i86r4o9rc8ofgdf4fplpc9eb2.apps.googleusercontent.com"; // the web client id from google console
            ...
            new GetTokenTask(LoginActivity.this, account, SCOPE).execute();
